 ...
 */
  ...
  function renderDataSelection(data, idx, delay) {
    ...
    function checkSticky(id, idx) {
      ...
      // we basically attempt to render, if rendering doesn't succeed then
      // similar to check serial
      // could in theory fall into a nasty position whenever it tries to render, someone was
      // rendered already, so it's not following the order over which it was received
