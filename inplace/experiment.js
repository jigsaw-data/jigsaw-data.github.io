 ...
 */
  ...
  function updateQuestion(taskMode, acceptingAnswer) {
    ...
    if (taskMode === TaskModes.TREND) {
      ...
      if (acceptingAnswer) {
        question = 'Which state has the maximum value? ' +
    ...
    if (state.step === Modes.WORK || state.instructionsTaskNum > 2) {
      ...
      if (state.instructionsTaskNum == 1) {
        ...
        $('#step-2-instructions').append(
          ...
          'to the previous graph you saw. Now when you hover over a region of the ' +
          'map, the numbers will not update immediately but they will ' +
        ...
        $('#step-2-instructions').append(
          ...
          'to the previous graph you saw, and the value of the region might not ' +
          'update in the same order that you hover over regions of the map. ' +
          'The data being shown here is exactly the same as in the previous ' +
          'graph. Spend some time interacting with the visualization below ' +
          'to familiarize yourself with how the delay affects the graph.</p>'
        );
        $('#step-2-instructions').append(
          '<p>When you are ready, you can click the "Next" button below to ' +
          ...
          'be an intentional loading delay of the region values, and the delay will ' +
